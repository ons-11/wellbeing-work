...
public class PublicationServiceImp implements PublicationIservice{
	...
	log.info("in method");
	List<BestAndWorstPub> p = PublicationRepository.bestpub();	
	...
	public List<BestAndWorstPub> WorstPubeachMonth() {
		log.info("in method");
		List<BestAndWorstPub> p = PublicationRepository.worstpub();
			log.info("out of method");
			return p;
	}
	...
	public  List<ActiveEmployeee> activeusereachMonth() {
		log.info("in method");
		List<ActiveEmployeee> p = PublicationRepository.activePerson();
			log.info("out of method");
			return p;
	}
	@Override
...
public List<User> getpublikes(Long idpub) {
	...
	return (List<User>) PublicationRepository.findById(idpub).orElseGet(null).getLikes();
